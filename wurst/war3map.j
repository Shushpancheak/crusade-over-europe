...
trigger gg_trg_Thatched_Cottage_2_Byz_Copy= null
trigger gg_trg_Thatched_Cottage_3_Byz_Copy= null
...
//===========================================================================
// 
// Crusade over Europe 0.167
// 
//   Warcraft III map script
//   Generated by the Warcraft III World Editor
//   Date: Mon Jan 28 15:55:47 2019
//   Map Author: S02
// 
//===========================================================================
...
//===========================================================================
// Trigger: Thatched Cottage 2 Byz Copy
//===========================================================================
function Trig_Thatched_Cottage_2_Byz_Copy_Func003C takes nothing returns boolean
    if ( not ( GetResearched() == 'R004' ) ) then
        return false
    endif
    if ( not ( GetPlayerTechCountSimple('R004', GetOwningPlayer(GetResearchingUnit())) == 1 ) ) then
...
function Trig_Thatched_Cottage_2_Byz_Copy_Conditions takes nothing returns boolean
    if ( not Trig_Thatched_Cottage_2_Byz_Copy_Func003C() ) then
        return false
    endif
    return true
endfunction

function Trig_Thatched_Cottage_2_Byz_Copy_Actions takes nothing returns nothing
    call SetPlayerUnitAvailableBJ('h06R', true, GetOwningPlayer(GetResearchingUnit()))
    call SetPlayerUnitAvailableBJ('h06O', false, GetOwningPlayer(GetResearchingUnit()))
endfunction

//===========================================================================
function InitTrig_Thatched_Cottage_2_Byz_Copy takes nothing returns nothing
    set gg_trg_Thatched_Cottage_2_Byz_Copy=CreateTrigger()
    call TriggerRegisterAnyUnitEventBJ(gg_trg_Thatched_Cottage_2_Byz_Copy, EVENT_PLAYER_UNIT_RESEARCH_FINISH)
    call TriggerAddCondition(gg_trg_Thatched_Cottage_2_Byz_Copy, Condition(function Trig_Thatched_Cottage_2_Byz_Copy_Conditions))
    call TriggerAddAction(gg_trg_Thatched_Cottage_2_Byz_Copy, function Trig_Thatched_Cottage_2_Byz_Copy_Actions)
endfunction

//===========================================================================
// Trigger: Thatched Cottage 3 Byz Copy
//===========================================================================
function Trig_Thatched_Cottage_3_Byz_Copy_Func003C takes nothing returns boolean
    if ( not ( GetResearched() == 'R004' ) ) then
        return false
    endif
    if ( not ( GetPlayerTechCountSimple('R004', GetOwningPlayer(GetResearchingUnit())) == 1 ) ) then
...
function Trig_Thatched_Cottage_3_Byz_Copy_Conditions takes nothing returns boolean
    if ( not Trig_Thatched_Cottage_3_Byz_Copy_Func003C() ) then
        return false
    endif
    return true
endfunction

function Trig_Thatched_Cottage_3_Byz_Copy_Actions takes nothing returns nothing
    call SetPlayerUnitAvailableBJ('h06S', true, GetOwningPlayer(GetResearchingUnit()))
    call SetPlayerUnitAvailableBJ('h06P', false, GetOwningPlayer(GetResearchingUnit()))
endfunction

//===========================================================================
function InitTrig_Thatched_Cottage_3_Byz_Copy takes nothing returns nothing
    set gg_trg_Thatched_Cottage_3_Byz_Copy=CreateTrigger()
    call TriggerRegisterAnyUnitEventBJ(gg_trg_Thatched_Cottage_3_Byz_Copy, EVENT_PLAYER_UNIT_RESEARCH_FINISH)
    call TriggerAddCondition(gg_trg_Thatched_Cottage_3_Byz_Copy, Condition(function Trig_Thatched_Cottage_3_Byz_Copy_Conditions))
    call TriggerAddAction(gg_trg_Thatched_Cottage_3_Byz_Copy, function Trig_Thatched_Cottage_3_Byz_Copy_Actions)
endfunction
...
function Trig_Capitol_1_Dummies_Actions takes nothing returns nothing
    call CreateNUnitsAtLoc(1, 'htow', GetOwningPlayer(GetConstructedStructure()), OffsetLocation(GetRectCenter(GetPlayableMapRect()), 100000000.00, 1000000000.00), bj_UNIT_FACING)
    call ShowUnitHide(GetLastCreatedUnit())
endfunction
...
function Trig_Capitol_1_Dummies_Copy_Actions takes nothing returns nothing
    call CreateNUnitsAtLoc(1, 'hkee', GetOwningPlayer(GetConstructedStructure()), OffsetLocation(GetRectCenter(GetPlayableMapRect()), 100000000.00, 1000000000.00), bj_UNIT_FACING)
    call ShowUnitHide(GetLastCreatedUnit())
endfunction
...
function Trig_Capitol_1_Dummies_Copy_Copy_Actions takes nothing returns nothing
    call CreateNUnitsAtLoc(1, 'hcas', GetOwningPlayer(GetConstructedStructure()), OffsetLocation(GetRectCenter(GetPlayableMapRect()), 100000000.00, 1000000000.00), bj_UNIT_FACING)
    call ShowUnitHide(GetLastCreatedUnit())
endfunction
...
function InitCustomTriggers takes nothing returns nothing
    ...
    call InitTrig_Thatched_Cottage_2_Byz_Copy()
    call InitTrig_Thatched_Cottage_3_Byz_Copy()
