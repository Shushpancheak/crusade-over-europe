...
trigger gg_trg_Dummies= null
trigger gg_trg_Capitol_1_Dummies= null
trigger gg_trg_Capitol_1_Dummies_Copy= null
trigger gg_trg_Capitol_1_Dummies_Copy_Copy= null
...
trigger gg_trg_CITY_HALL_Copy= null
trigger gg_trg_Castle_BYZ_T1_Copy= null
...
//===========================================================================
// 
// Crusade over Europe 0.175
// 
//   Warcraft III map script
//   Generated by the Warcraft III World Editor
//   Date: Sun Feb 10 13:58:14 2019
//   Map Author: S02
// 
//===========================================================================
...
// Trigger: Dummies
//===========================================================================
function Trig_Dummies_Func005C takes nothing returns boolean
...
function Trig_Dummies_Conditions takes nothing returns boolean
    if ( not ( udg_hasBarracks[GetConvertedPlayerId(GetOwningPlayer(GetConstructedStructure()))] == false ) ) then
        return false
    endif
    if ( not Trig_Dummies_Func005C() ) then
        return false
    endif
    return true
endfunction
...
function InitTrig_Dummies takes nothing returns nothing
    ...
    call TriggerRegisterAnyUnitEventBJ(gg_trg_Dummies, EVENT_PLAYER_UNIT_CONSTRUCT_FINISH)
    call TriggerAddCondition(gg_trg_Dummies, Condition(function Trig_Dummies_Conditions))
...
//===========================================================================
// Trigger: Capitol 1 Dummies Copy
//===========================================================================
function Trig_Capitol_1_Dummies_Copy_Func001C takes nothing returns boolean
...
function Trig_Capitol_1_Dummies_Copy_Conditions takes nothing returns boolean
    if ( not Trig_Capitol_1_Dummies_Copy_Func001C() ) then
        return false
    endif
    return true
endfunction

function Trig_Capitol_1_Dummies_Copy_Actions takes nothing returns nothing
...
//===========================================================================
function InitTrig_Capitol_1_Dummies_Copy takes nothing returns nothing
    set gg_trg_Capitol_1_Dummies_Copy=CreateTrigger()
    call TriggerRegisterAnyUnitEventBJ(gg_trg_Capitol_1_Dummies_Copy, EVENT_PLAYER_UNIT_UPGRADE_FINISH)
    call TriggerAddCondition(gg_trg_Capitol_1_Dummies_Copy, Condition(function Trig_Capitol_1_Dummies_Copy_Conditions))
    call TriggerAddAction(gg_trg_Capitol_1_Dummies_Copy, function Trig_Capitol_1_Dummies_Copy_Actions)
endfunction

//===========================================================================
// Trigger: Capitol 1 Dummies Copy Copy
//===========================================================================
function Trig_Capitol_1_Dummies_Copy_Copy_Func001C takes nothing returns boolean
...
function Trig_Capitol_1_Dummies_Copy_Copy_Conditions takes nothing returns boolean
    if ( not Trig_Capitol_1_Dummies_Copy_Copy_Func001C() ) then
        return false
    endif
    return true
endfunction

function Trig_Capitol_1_Dummies_Copy_Copy_Actions takes nothing returns nothing
...
//===========================================================================
function InitTrig_Capitol_1_Dummies_Copy_Copy takes nothing returns nothing
    set gg_trg_Capitol_1_Dummies_Copy_Copy=CreateTrigger()
    call TriggerRegisterAnyUnitEventBJ(gg_trg_Capitol_1_Dummies_Copy_Copy, EVENT_PLAYER_UNIT_UPGRADE_FINISH)
    call TriggerAddCondition(gg_trg_Capitol_1_Dummies_Copy_Copy, Condition(function Trig_Capitol_1_Dummies_Copy_Copy_Conditions))
    call TriggerAddAction(gg_trg_Capitol_1_Dummies_Copy_Copy, function Trig_Capitol_1_Dummies_Copy_Copy_Actions)
endfunction
...
//===========================================================================
// Trigger: CITY HALL Copy
//===========================================================================
function Trig_CITY_HALL_Copy_Func002C takes nothing returns boolean
    if ( not ( GetUnitTypeId(GetTriggerUnit()) == 'h03M' ) ) then
        return false
    endif
    return true
...
function Trig_CITY_HALL_Copy_Conditions takes nothing returns boolean
    if ( not Trig_CITY_HALL_Copy_Func002C() ) then
        return false
    endif
    return true
endfunction

function Trig_CITY_HALL_Copy_Actions takes nothing returns nothing
    call UnitAddAbilityBJ('A02B', GetTriggerUnit())
endfunction

//===========================================================================
function InitTrig_CITY_HALL_Copy takes nothing returns nothing
    set gg_trg_CITY_HALL_Copy=CreateTrigger()
    call TriggerRegisterAnyUnitEventBJ(gg_trg_CITY_HALL_Copy, EVENT_PLAYER_UNIT_UPGRADE_FINISH)
    call TriggerAddCondition(gg_trg_CITY_HALL_Copy, Condition(function Trig_CITY_HALL_Copy_Conditions))
    call TriggerAddAction(gg_trg_CITY_HALL_Copy, function Trig_CITY_HALL_Copy_Actions)
endfunction

//===========================================================================
// Trigger: Castle BYZ T1 Copy
//===========================================================================
function Trig_Castle_BYZ_T1_Copy_Func002C takes nothing returns boolean
    if ( not ( GetUnitTypeId(GetConstructedStructure()) == 'h07Q' ) ) then
        return false
    endif
    return true
...
function Trig_Castle_BYZ_T1_Copy_Conditions takes nothing returns boolean
    if ( not Trig_Castle_BYZ_T1_Copy_Func002C() ) then
        return false
    endif
    return true
endfunction

function Trig_Castle_BYZ_T1_Copy_Actions takes nothing returns nothing
    call UnitAddAbilityBJ('A03H', GetConstructedStructure())
endfunction

//===========================================================================
function InitTrig_Castle_BYZ_T1_Copy takes nothing returns nothing
    set gg_trg_Castle_BYZ_T1_Copy=CreateTrigger()
    call TriggerRegisterAnyUnitEventBJ(gg_trg_Castle_BYZ_T1_Copy, EVENT_PLAYER_UNIT_CONSTRUCT_FINISH)
    call TriggerAddCondition(gg_trg_Castle_BYZ_T1_Copy, Condition(function Trig_Castle_BYZ_T1_Copy_Conditions))
    call TriggerAddAction(gg_trg_Castle_BYZ_T1_Copy, function Trig_Castle_BYZ_T1_Copy_Actions)
endfunction
...
function InitCustomTriggers takes nothing returns nothing
    ...
    call InitTrig_Dummies()
    call InitTrig_Capitol_1_Dummies()
    call InitTrig_Capitol_1_Dummies_Copy()
    call InitTrig_Capitol_1_Dummies_Copy_Copy()
    ...
    call InitTrig_CITY_HALL_Copy()
    call InitTrig_Castle_BYZ_T1_Copy()
endfunction
